...
# Program Name: Building object detecting model - retinanet
...
# Define Intersection Over Union (IOU) -> solve overlapping of anchor boxes
...
class LabelEncoder:
    ...
    # Match anchor boxes based on IOU
    ...
    # Generate box and classfication
...
# Define Feature Pyramid Network (FPN) Layer
...
# Load the COCO Dataset and splite train test
